...
def load_works():
    ...
    for book in progress:
        ...
        try: 
            birth_year_plain = author_metadata.get('birth').get('plain')
        except:
            birth_year_plain = author_metadata.get('birth')

        try: 
            death_year_plain = author_metadata.get('death').get('plain')
        except:
            death_year_plain = author_metadata.get('death')
        ...
        author, _   = models.Author.objects.update_or_create(
            ...
            birth_year_plain=birth_year_plain,
            death_year=death_year,
            death_year_plain=death_year_plain,
        )
